...
namespace TightWiki.Data.EfCore.SqlServer
{
    ...
    /// stejný connection string ... a stejného providera jako aktivní driver").
    /// </summary>
    public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            //SQL Server migrations belong in this driver project, not in TightWiki.Library - MigrationsAssembly
            ...
            //matching comment on SqlServerDatabaseManager.CreateApplicationDbContext for why two DbContexts
            //over one database must not share EF Core's default dbo.__EFMigrationsHistory table.
