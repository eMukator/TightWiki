...
{
    /// <summary>
    /// A page revision that belonged to a page before it was soft-deleted (DeletedPages.PageRevision), moved
    /// here verbatim from Pages.PageRevision.
    /// </summary>
    public class PageRevision
    {
        /// <summary>
        /// The identifier of the deleted page this revision belongs to. Part of the composite primary key
